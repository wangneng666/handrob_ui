...
public:
    ...
    QGridLayout *gLayout_tabmain_tatus;
    QLabel *lable_tabmain_handGraw_conn;
    QLabel *label_tabmain_forceconn;
    QLabel *label_tabmain_rbConn;
    QLabel *label_tabmain_force_pic;
    QLabel *label_tabmain_d435iConn;
    QLabel *label_tabmain_d435i_pic;
    QLabel *label_tabmain_rb_pic;
    QLabel *label_tabmain_kinect_pic;
    QLabel *label_tabmain_kinectconn;
    QLabel *lable_tabmain_handGraw_pic;
    ...
    QGroupBox *gBox_tabvoiceSH_status;
    QHBoxLayout *horizontalLayout_16;
    QGridLayout *gridLayout_tabvoiceSH_status;
    QLabel *label_tabvoiceSH_rbok;
    QLabel *label_rbservook;
    QLabel *label_fsmbridge;
    QLabel *label_voiceok;
    QLabel *label_dmbridgeok;
    QLabel *label_plannerok;
    QLabel *label_motionbridgeok;
    QLabel *label_forceok;
    QLabel *label_forcebridge;
    QLabel *label_shakehandJudge;
    ...
    QLabel *label_tabvoiceSH_homepointstate;
